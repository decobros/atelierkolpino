...
<body>
    ...
    <main class="content-wrapper" style="padding-top: 6px;">
        ...
        <div class="info-page-block">
            <h1 class="info-page-title">Искусство создавать стиль с 2010 года</h1>
            
            <div class="info-page-text">
                <p>Добро пожаловать в наше ателье! Мы — команда страстных профессионалов, влюбленных в искусство шитья и создания уникального стиля. Наша история началась более десятилетия назад, и с тех пор мы накопили колоссальный опыт в работе с тканями любых фактур и сложности.</p>
                
                <div class="fake-img-box">
                    <span>ЗАГЛУШКА ИЗОБРАЖЕНИЯ</span>
                    <span style="font-size: 13px; font-weight: normal; margin-top: 5px;">Имя: about_1.jpg<br>Рекомендуемый размер: Горизонтальное фото (16:9)</span>
                </div>
                <p>В чем наш секрет? В безупречном внимании к деталям. Мы верим, что одежда должна не просто скрывать недостатки, а подчеркивать вашу индивидуальность, транслировать ваш характер и обеспечивать невероятный комфорт.</p>
                
                <p>К каждому заказу, будь то пошив роскошного вечернего платья, строгий мужской костюм или бережная реставрация любимой кожаной куртки, мы подходим с душой. Мы используем только проверенную фурнитуру, премиальные нити и современное итальянское оборудование.</p>
                <div class="fake-img-box">
                    <span>ЗАГЛУШКА ИЗОБРАЖЕНИЯ</span>
                    <span style="font-size: 13px; font-weight: normal; margin-top: 5px;">Имя: about_2.jpg<br>Рекомендуемый размер: Горизонтальное фото (16:9)</span>
                </div>
                <p>Наша главная награда — это ваши счастливые улыбки на примерке. За годы работы мы стали семейным ателье для сотен жителей нашего города. Доверьте нам свои идеи, и мы воплотим их в безупречные формы с точностью до миллиметра.</p>
                <p style="font-weight: bold; color: var(--brand-text-color);">С любовью, Ателье Татьяны Усановой.</p>
            </div>
        </div>
        <!-- === СЕТКА ТОВАРОВ === -->
